...
cat << EOF > configuration-custom.json
{
  "configurations" : {
    ...
    "ranger-ugsync-site": {
          ...
          "ranger.usersync.group.searchbase" : "ou=CorpUsers,dc=lab,dc=hortonworks,dc=net",
          ...
          "ranger.usersync.ldap.searchBase" : "ou=CorpUsers,ou=dc=lab,dc=hortonworks,dc=net",
