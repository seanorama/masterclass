...
cd masterclass/prepare/ambari/views
...
beeline -n admin -u jdbc:hive2://$(hostname -f):10000/default -e \
  "LOAD DATA INPATH '/temp/admin/data/geolocation.csv' OVERWRITE INTO TABLE geolocation_stage;"
beeline -n admin -u jdbc:hive2://$(hostname -f):10000/default -e \
